...
("390234","stud115","Deamon Anduro" ,"0755421123",22,"Female");
...
SET stud_email = (SELECT CONCAT(REPLACE (stud_name,' ','') ,'@chaptrglobal.ac')
					FROM personal_details
...
("0741367812","Daisy Auma","Mother","0791353537"),
